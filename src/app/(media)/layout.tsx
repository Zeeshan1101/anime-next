...
export default function Layout({ children }: { children?: ReactNode }) {
    return (
        <div className="flex min-h-screen w-full flex-col py-4 [--gap:1rem] [--padding-x:1rem] sm:[--gap:1.5rem] sm:[--padding-x:1.5rem] md:[--gap:2rem] md:[--padding-x:2rem] lg:[--gap:2.5rem] lg:[--padding-x:3rem]">
